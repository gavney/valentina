...
const phrases = [
  ...
  "недавно мне сон крутой приснился, мы там с тобой ездили в индонезию и попали в очень странное место, там было очень много бассейнов в которых купались старики",
  "но примечательно было не это, а тот факт что в центре каждого бассейна росли десятки деревьев, на каждом из которых висели спелые огромные фрукты типа бананы манго и тд, но их никто не ел",
  "мы залезли и начали их срывать, они были очень вкусными, все на нас обернулись и я проснулся",
  "успела прочитать?",
  "ну и ладно",
  "сегодня я 2 часа клеил книжку, каждую страницу ламинировал скотчем и потом всё степлером закрепил",
  "всё, пора спать",
  "хотя честно хочу еще немного побыть с тобой",
  "как жизнь?",
  "Завтра, 13 февраля, будет небольшой дождь, восточный ветер - будь готова",
  "а еще мне отправят документы на подписание, чтоб устроиться преподом",
  "но сначала я пойду груд качат в ддх",
