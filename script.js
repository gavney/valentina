...
const phrases = [
  ...
  "но примечательно было не это, а тот факт что в цетре каждого бассейна росли десятки деревьев, на каждом из которых висели спелые огромные фрукты типа бананы манго и тд, но их никто не ел, мы залезли и начали их срывать, они были очень вкусными, все на нас обернулись и я проснулся",
  "успела прочитать",
  "ну и ладно",
